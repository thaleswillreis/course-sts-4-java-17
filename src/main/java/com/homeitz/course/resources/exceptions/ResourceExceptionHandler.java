package com.homeitz.course.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	//insterceptacao de erros do tipo ResourceNotFoundException pelo metodo resourceNotFound para ser tratado
